...
<body>
    ...
    Le pedimos nos comparta los siguientes documentos para validar los datos ingresados:<br>
    <br>
    1. Identificación oficial (INE/IFE)<br>
    2. Comprobante de domicilio<br>
    3. Título Universidario<br>
    <br>
    Suba los documentos en el siguiente link: http://127.0.0.1:5000/ <br>
    <br>
    Gracias!<br>
    <p></p>
    Excelente día!<br>
